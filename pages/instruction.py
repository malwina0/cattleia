...
layout = html.Div([
    dbc.Row([
        ...
        dbc.Col(html.Img(src="assets/images/train.png", height="60px"), align="center", width='auto'),
    ], justify="start"),
    ...
    dbc.Row([
        ...
        dbc.Col(html.Img(src="assets/images/save.png", height="50px"), align="center", width='auto'),
    ], justify="start"),
